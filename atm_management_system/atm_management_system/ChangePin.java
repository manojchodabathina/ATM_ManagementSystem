...
public class ChangePin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        NewPinTxt.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        NewPinTxt.setForeground(new java.awt.Color(255, 0, 0));
        NewPinTxt.setHorizontalAlignment(javax.swing.JTextField.LEFT);

        ChangeBtn.setFont(new java.awt.Font("Segoe UI Historic", 1, 18)); // NOI18N
        ...
        ConfirmTxt.setForeground(new java.awt.Color(255, 0, 0));
        ConfirmTxt.setHorizontalAlignment(javax.swing.JTextField.LEFT);
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(NewPinTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(ConfirmTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(213, 213, 213)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(NewPinTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
                    .addComponent(ConfirmTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void ChangeBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ChangeBtnMouseClicked
        if (NewPinTxt.getText().isEmpty() || ConfirmTxt.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Enter and Confirm The Pin");
        } else if (!NewPinTxt.getText().equals(ConfirmTxt.getText())) {
            JOptionPane.showMessageDialog(this, "New PIN And Confirm PIN Are Not Same");
        } else {
            try {
                String Query = "Update AccountTable set Pin = ? where AccNo = ?";
                Con = DriverManager.getConnection("jdbc:mysql://localhost:3308/atm_management_system", "root", "root");
                PreparedStatement ps = Con.prepareStatement(Query);
                ps.setInt(1, Integer.valueOf(NewPinTxt.getText()));
